...
const dict = {
  ...
  "a.new.employer.subtitle": { en: "Company that hires labors through Vertex.", es: "Empresa que contrata mano de obra a través de Vertex.", pt: "Empresa contratante de mão de obra através da Vertex." },
  "a.new.worker.title":      { en: "New worker",      es: "Nuevo trabajador", pt: "Novo colaborador" },
  "a.new.worker.subtitle":   { en: "Add a hired labor to the workforce roster.", es: "Agrega un trabajador contratado al equipo.", pt: "Adicione um colaborador contratado ao quadro." },
  "a.new.project.title":     { en: "New project",     es: "Nuevo proyecto",   pt: "Novo projeto" },
  "a.new.project.subtitle":  { en: "Define the engagement so you can roll up workers, hours, and margin.", es: "Define el proyecto para consolidar trabajadores, horas y margen.", pt: "Defina o projeto para consolidar colaboradores, horas e margem." },
  "a.new.placement.title":   { en: "New placement",   es: "Nueva asignación", pt: "Nova alocação" },
  "a.new.placement.subtitle":{ en: "Assign a worker to an employer (and optional project) with pay and bill rates.", es: "Asigna un trabajador a un empleador (y proyecto opcional) con tarifas de pago y facturación.", pt: "Aloca um colaborador a uma empresa (e projeto opcional) com tarifa paga e cobrada." },
  "a.section.notes":         { en: "Notes",           es: "Notas",            pt: "Anotações" },
  "a.section.identity":      { en: "Identity",        es: "Identidad",        pt: "Identificação" },
  "a.section.employment":    { en: "Employment",      es: "Empleo",           pt: "Vínculo" },
  "a.section.tax_compliance":{ en: "Tax & compliance",es: "Impuestos y cumplimiento", pt: "Impostos e compliance" },
  "a.section.company":       { en: "Company",         es: "Empresa",          pt: "Empresa" },
  "a.section.billing_rates": { en: "Billing rates & Vertex cost", es: "Tarifas de facturación y costo Vertex", pt: "Tarifas cobradas e custo Vertex" },
  "a.section.fallback_mult": { en: "Fallback multiplier", es: "Multiplicador de respaldo", pt: "Multiplicador padrão" },
  "a.section.assignment":    { en: "Assignment",      es: "Asignación",       pt: "Alocação" },
  "a.section.rates":         { en: "Rates",           es: "Tarifas",          pt: "Tarifas" },
  "a.section.period":        { en: "Period",          es: "Período",          pt: "Período" },
  "a.section.basics":        { en: "Basics",          es: "Básico",           pt: "Básico" },
